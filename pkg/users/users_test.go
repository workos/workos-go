...
func TestUsersAuthenticateUserWithCode(t *testing.T) {
	...
	authenticationRes, err := AuthenticateUserWithCode(context.Background(), AuthenticateWithCodeOpts{})
...
func TestUsersAuthenticateUserWithPassword(t *testing.T) {
	...
	authenticationRes, err := AuthenticateUserWithPassword(context.Background(), AuthenticateWithPasswordOpts{})
